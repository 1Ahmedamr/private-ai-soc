...
- Dashboard authentication: HTTP Basic Auth via environment variables,
  using secrets.compare_digest to prevent timing attacks. See
  src/webapp/app.py. Default credentials MUST be changed before any
  shared-network use - see INSTALLATION.md.
